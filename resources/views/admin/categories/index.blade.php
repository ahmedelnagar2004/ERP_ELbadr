...
<div class="page-header flex items-center justify-between mb-6">
    <div>
        <h2 class="text-xl font-bold text-gray-900">قائمة الفئات</h2>
        <p class="text-sm text-gray-500 mt-1">إدارة الفئات والتنظيم</p>
    </div>
    <a href="{{ route('admin.categories.create') }}" class="btn-primary">إضافة فئة جديدة</a>
    </div>
